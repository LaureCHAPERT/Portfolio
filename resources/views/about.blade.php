@include('layouts/navbar')
        ...
        <h1> Mon parcours </h1>
                    ...
                    <div class="about-first-responsive">
                        ...
                        <p>
                        Je viens de passer ma certification Opquast attestant d'un niveau avancé en matières de règles qualité en projet web (accessibilité, ergonomie, etc...). <br> Mon score est de 895/1000 (à 5 points du dernier niveau : expert ... &#128517 ) <br>
